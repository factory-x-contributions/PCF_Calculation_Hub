...
class Settings(BaseSettings):
    ...
    # Green Grid Compass (carbon intensity source "grid")
    grid_client_id: str = Field(default="", validation_alias="GRID_CLIENT_ID")
    grid_client_secret: str = Field(default="", validation_alias="GRID_CLIENT_SECRET")
